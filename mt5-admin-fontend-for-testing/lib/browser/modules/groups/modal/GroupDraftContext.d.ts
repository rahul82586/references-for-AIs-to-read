...
export declare const DEFAULT_DRAFT: GroupDraft;
...
export declare const GroupDraftContext: React.Context<GroupDraftContextProps | undefined>;
export declare function useGroupDraft(): GroupDraftContextProps;
export {};
//# sourceMappingURL=GroupDraftContext.d.ts.map