...
|---|---|---|
| **The working engine (M0–M10 + D1/D2 + proofs)** | `github.com/rahul82586/references-for-AIs-to-read` → `qwe-agen-broker-platform-backend/work/bp/` | ✅ pushed 2026-09-11 16:10 UTC. Local working tree `work/bp` is **3 commits ahead** (`ca87258`) — *not yet pushed* |
...
| `work/bp/scripts/run_all_proofs.sh` | **`make proofs`** — every gate in one command. 13/13 |
...
**Local git:** `work/bp` is at `ca87258`, **3 commits ahead of GitHub `a054423c`** and not
