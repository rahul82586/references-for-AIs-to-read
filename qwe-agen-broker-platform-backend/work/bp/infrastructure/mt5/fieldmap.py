...
GROUP_FIELDS: Tuple[Field, ...] = (
    ...
    Field("PermissionsFlags", "permissions_flags", FLAGS),
    ...
    Field("AuthMode", "auth_mode", INT),
    Field("AuthPasswordMin", "auth_password_min", INT),
    Field("AuthOTPMode", "auth_otp_mode", INT),
    # White label
    Field("Company", "company", STR),
    Field("CompanyPage", "company_page", STR),
    Field("CompanyEmail", "company_email", STR),
    Field("CompanySupportPage", "company_support_page", STR),
    Field("CompanySupportEmail", "company_support_email", STR),
    Field("CompanyCatalog", "company_catalog", STR),
    Field("CompanyDepositURL", "company_deposit_url", STR),
    Field("CompanyWithdrawalURL", "company_withdrawal_url", STR),
    # Currency
    Field("Currency", "currency", STR),
    Field("CurrencyDigits", "currency_digits", INT),
    # Reports & mail - deferred by scope
    Field("ReportsMode", "reports_mode", INT),
    Field("ReportsFlags", "reports_flags", FLAGS),
    Field("ReportsEmail", "reports_email", STR),
    Field("NewsMode", "news_mode", INT),
    Field("NewsCategory", "news_category", STR),
    Field("NewsLangs", "news_langs", STRLIST),
    Field("MailMode", "mail_mode", INT),
    # Trading
    Field("TradeFlags", "trade_flags", FLAGS),
    Field("TradeTransferMode", "trade_transfer_mode", INT),
    Field("TradeInterestrate", "trade_interestrate", DEC),
    Field("TradeVirtualCredit", "trade_virtual_credit", DEC),
    ...
    Field("MarginFreeProfitMode", "margin.free_profit_mode", INT),
    # Demo
    Field("DemoLeverage", "demo_leverage", INT),
    Field("DemoDeposit", "demo_deposit", DEC),
    Field("DemoTradesClean", "demo_trades_clean", INT),
    # Limits
    Field("LimitHistory", "limit_history", INT),
    Field("LimitOrders", "limit_orders", INT),
    Field("LimitSymbols", "limit_symbols", INT),
    Field("LimitPositions", "limit_positions", INT),
    Field("LimitPositionsVolume", "limit_positions_volume", DEC),
