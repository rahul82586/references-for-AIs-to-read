...
class SeedReport:
    ...
    def as_dict(self) -> Dict[str, Any]:
        data = {
            ...
            "coverage_risk_accounts": self.coverage_risk_accounts,
...
async def ensure_coverage_risk_account(
    coverage_repo: Any,
    group_repo: Any,
    report: SeedReport,
    *,
...
async def seed_all(
    *,
    ...
    await ensure_coverage_risk_account(coverage_repo, group_repo, report)
